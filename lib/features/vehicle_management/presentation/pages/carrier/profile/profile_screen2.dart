    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildDrawerItem(Icons.person, 'PROFILE', ProfileScreen2(userId: widget.userId, name: widget.name, lastName: widget.lastName)),
          _buildDrawerItem(Icons.report, 'REPORTS', ReportsCarrierScreen(userId: widget.userId, name: widget.name, lastName: widget.lastName)),
          _buildDrawerItem(Icons.directions_car, 'VEHICLES', VehicleDetailCarrierScreenScreen(userId: widget.userId, name: widget.name, lastName: widget.lastName)),
          _buildDrawerItem(Icons.local_shipping, 'SHIPMENTS', ShipmentsScreen2(userId: widget.userId, name: widget.name, lastName: widget.lastName)),
