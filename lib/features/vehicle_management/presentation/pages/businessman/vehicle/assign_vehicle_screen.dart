          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                // FIX 1: Added const to TextStyle
                child: const Text('Asignar Vehículo', style: const TextStyle(color: Colors.black)),
              ),
            ],
          ),
        ),
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(
                  // FIX 2: Removed 'const' because LoginScreen likely doesn't have a const constructor.
